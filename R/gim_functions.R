...
# implementation of GIM test for OLS via bootstrapping
bootstrapIM <- function(lm1, B, B2, cluster=NA, time=NA){

    if(family(lm1)$family == 'gaussian'){
        ...
        for(i in 1:B){
            ...
            # NOTE:
            # is the line below this comment an error should it be model.matrix(lm1)[,-1] to remove
            # intercept but not subtract 1 from the entire model matrix?
